        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 text-sm font-bold px-6 py-3 rounded-xl transition-colors"
      ...
      <section className="text-white px-4 sm:px-6 py-16" style={{ backgroundColor: '#18181b' }}>
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-sm font-bold px-6 py-3 rounded-xl transition-colors flex-shrink-0"
            style={{ backgroundColor: '#F5C400', color: '#000000' }}
          >
