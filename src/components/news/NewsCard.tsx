...
export default function NewsCard({ article, variant = "card" }: { article: NewsArticle; variant?: Variant }) {
  if (variant === "hero" || variant === "compact") {
    ...
    return (
      <article className="group overflow-hidden border border-white/15 bg-zinc-950 transition hover:border-[#f4c300] hover:-translate-y-0.5">
  ...
  const classes = variant === "list"
    ? "group overflow-hidden border border-white/15 bg-zinc-950 transition hover:-translate-y-0.5 hover:border-[#f4c300]"
    : "group overflow-hidden border border-white/15 bg-zinc-950 transition hover:-translate-y-0.5 hover:border-[#f4c300]";
