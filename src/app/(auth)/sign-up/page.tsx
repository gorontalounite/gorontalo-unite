      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-white text-gray-400">atau daftar dengan email</span>
            </div>
          </div>
          ...
          <p className="text-center text-xs text-gray-500">
            Sudah punya akun?{" "}
            <Link href="/sign-in" className="text-[#2D7D46] font-medium hover:underline">Masuk</Link>
          </p>
        </div>
