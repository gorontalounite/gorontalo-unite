    ...
    <div className="w-full pb-24 md:pb-0">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 pt-16 pb-20 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight tracking-tight mb-6">
          ...
          <span className="text-[#2D7D46] dark:text-emerald-400">untuk Gorontalo.</span>
        </h1>
            ...
            {[
              ...
              return (
                <div key={bold} className="flex items-start gap-3 text-sm text-gray-600 dark:text-gray-400">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#2D7D46] dark:bg-emerald-400 flex-shrink-0 mt-2" />
      ...
      <section className="border-t border-gray-100 dark:border-zinc-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          <p className="text-xs font-semibold uppercase tracking-widest text-[#2D7D46] dark:text-emerald-400 mb-3">Liputan</p>
      ...
      <section className="border-t border-gray-100 dark:border-zinc-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          <p className="text-xs font-semibold uppercase tracking-widest text-[#2D7D46] dark:text-emerald-400 mb-3">Media Sosial</p>
          ...
          <div className="flex flex-wrap gap-3">
            {SOCIALS.map((s) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 px-4 py-3 rounded-xl border border-gray-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-sm font-medium text-gray-700 dark:text-gray-300 hover:border-[#2D7D46]/40 dark:hover:border-emerald-500/40 hover:text-[#2D7D46] dark:hover:text-emerald-400 transition-all"
              >
                {s.icon}
                {s.label}
              </a>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="flex items-center gap-2 px-6 py-3 bg-[#2D7D46] text-white text-sm font-semibold rounded-xl hover:bg-[#236137] transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-6 py-3 border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-sm font-semibold text-gray-700 dark:text-gray-200 rounded-xl hover:border-[#2D7D46]/50 dark:hover:border-emerald-500/50 hover:text-[#2D7D46] dark:hover:text-emerald-400 transition-all"
            >
