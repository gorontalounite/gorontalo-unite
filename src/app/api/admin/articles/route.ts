...
const LIST_COLS =
  "id, title, slug, category, tags, published, published_at, created_at, deleted_at, excerpt, image_url, is_trending, editor_choice, is_sponsored, sponsor_name, sponsor_logo_url, source_permalink";
