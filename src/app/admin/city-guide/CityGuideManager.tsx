...
export default function CityGuideManager({
  ...
  return <div className="p-6">
    ...
    {open && <SidePanel open={open} onClose={() => setOpen(false)} title={editing ? `Edit ${itemWord}` : `Tambah ${itemWord}`} subtitle="Simpan sebagai draft dahulu atau terbitkan saat siap." width="min(880px, 94vw)"><form onSubmit={submit} className="p-5"><div className="grid gap-4 sm:grid-cols-2">
