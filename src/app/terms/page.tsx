...
export default function TermsPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <h1 className={`${PAGE_TITLE_CLASS} text-gray-900 mb-2`}>Syarat & Ketentuan</h1>
      <p className="text-xs text-gray-400 mb-8">Terakhir diperbarui: April 2026</p>

      <div className="prose prose-sm max-w-none text-gray-600 space-y-6">
        <section>
          <h2 className={`${SUBHEAD_CLASS} text-gray-800 mb-2`}>1. Penerimaan Syarat</h2>
        ...
        <section>
          <h2 className={`${SUBHEAD_CLASS} text-gray-800 mb-2`}>2. Penggunaan Layanan</h2>
        ...
        <section>
          <h2 className={`${SUBHEAD_CLASS} text-gray-800 mb-2`}>3. Akurasi Informasi</h2>
        ...
        <section>
          <h2 className={`${SUBHEAD_CLASS} text-gray-800 mb-2`}>4. Akun Pengguna</h2>
        ...
        <section>
          <h2 className={`${SUBHEAD_CLASS} text-gray-800 mb-2`}>5. Perubahan Syarat</h2>
