  ...
  return (
    <div className="w-full pb-24 md:pb-0">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 pt-16 pb-20 text-center">
        <span className="inline-block text-xs font-semibold uppercase tracking-widest text-brand dark:text-yellow-400 mb-4">
          Tentang Kami
        </span>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight tracking-tight mb-6">
          ...
          <span className="text-brand dark:text-yellow-400">untuk Gorontalo.</span>
        </h1>
      ...
      <section className="border-t border-gray-100 dark:border-zinc-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          <p className="text-xs font-semibold uppercase tracking-widest text-brand dark:text-yellow-400 mb-3">Liputan</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {COVERAGE.map((f) => (
              ...
              >
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white group-hover:text-brand dark:group-hover:text-yellow-400 transition-colors mb-2">
      ...
      <section className="border-t border-gray-100 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-900/50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          <p className="text-xs font-semibold uppercase tracking-widest text-brand dark:text-yellow-400 mb-3">Tech Stack</p>
          ...
          <p className="mt-6 text-xs text-gray-400 dark:text-gray-500">
            ...
            <a
              ...
              className="text-brand dark:text-yellow-400 hover:underline"
            >
      ...
      <section className="border-t border-gray-100 dark:border-zinc-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          <p className="text-xs font-semibold uppercase tracking-widest text-brand dark:text-yellow-400 mb-3">Media Sosial</p>
          ...
          <div className="flex flex-wrap gap-3">
            {SOCIALS.map((s) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 px-4 py-3 rounded-xl border border-gray-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-sm font-medium text-gray-700 dark:text-gray-300 hover:border-[#F5C400]/40 dark:hover:border-yellow-500/40 hover:text-brand dark:hover:text-yellow-400 transition-all"
              >
                {s.icon}
                {s.label}
              </a>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-6 py-3 border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-sm font-semibold text-gray-700 dark:text-gray-200 rounded-xl hover:border-[#F5C400]/50 dark:hover:border-yellow-500/50 hover:text-brand dark:hover:text-yellow-400 transition-all"
            >
