  ...
  return (
    <div className="relative flex justify-center">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="w-7 h-7 rounded-full bg-white border-2 border-gray-200 text-gray-400 text-lg flex items-center justify-center hover:border-[#F5C400] hover:text-brand transition-all shadow-sm"
        title="Tambah blok"
      >
        +
      </button>
